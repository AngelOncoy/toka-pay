        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-br from-toka-orange to-toka-orange-600 rounded-lg flex items-center justify-center overflow-hidden">
                 <img src="/assets/logotokablanco.png" alt="TOKA Logo" className="object-contain w-5 h-5" />
              </div>
